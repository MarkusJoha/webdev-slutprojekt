...
public class GettheWeather {
	...
	public static void getWeather(weatherBean wBean) throws IOException {
		String API_KEY = "aa96fc900ebad3d77ae611cb5629340c";
		...
		wBean.setCloudsStr(FetchData(nList, "name"));
		wBean.setTemperature(FetchData(nList2, "value"));
		wBean.setDate(FetchData(nList3, "value"));
		
		
		
	}
	public static String FetchData(NodeList nList3, String Attribute) {
for (int temp3 = 0; temp3 < nList3.getLength(); temp3++) {
			...
			if (node3.getNodeType() == Node.ELEMENT_NODE) {
				...
				String XMLlastupdate = eElement3.getAttribute(Attribute);
